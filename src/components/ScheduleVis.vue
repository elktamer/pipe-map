<template>
  <div id='schedule-component-container'>
...
export default {
  ...
  mounted() {
    ...
    this.width = $("#schedule-container").width()
  ...
  methods: {
    createContainer() {
      this.svg = d3Select.select("#schedule-container")
                      .append("svg")
                          .append("g")
    },
    drawMap() {
    ...
    drawSites(data) {
      let sites = this.svg.selectAll('circle')
                            .data(data)
      // enter
      sites.enter()
              .append('circle')
    ...
    resizeMap() {
      ...
      this.drawLegend()
      this.drawSites(this.shiftTypes)
    },
    createTooltip() {
